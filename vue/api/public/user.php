<?php
	...
	//index.php?m=user&a=register&username=zz&password=123456&phone=1361111222
	function user_register($p)
	{
		...
		//执行注册
		//字符串两边要加''表示字符串, 数字不用加
		$sql = "insert into user(username,password,phone,image) values('$username','$password','$phone','images/head.png')";
		//echo $sql;
		$r = $connect->query($sql);
